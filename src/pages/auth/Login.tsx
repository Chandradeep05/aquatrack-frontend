    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 text-slate-100 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-slate-800 p-8 sm:p-10 relative z-10">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Sign In to AquaTrack</h1>
          <p className="text-sm text-slate-400 mt-1">Track your daily water intake and meet your goals.</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 flex flex-col gap-3 text-center">
          ...
          >
            Fill Demo Admin Email (admin@aquatrack.com)
          </button>
          <span className="text-[11px] text-slate-500 -mt-1">
            Password: Use your configured password from .env
          </span>
        </div>
      </div>
    </div>
